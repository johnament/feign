...
public class HystrixFeignClientBeanTest {
    @FeignClient(url="http://myApp", client = RibbonClient.class)
//    @EnableHystrix(fallbackFactory = SimpleFallbackFactory.class)
    ...
    public static Archive<?> createArchive() {
        return ShrinkWrap.create(JavaArchive.class).addClasses(TestInterface.class)
                .addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml")
                .addAsServiceProvider(Extension.class, FeignExtension.class);
    }

    public static final class SimpleFallbackFactory implements FallbackFactory<TestInterface> {
    ...
    @Test
    public void shouldExecuteWithFallback() {
        String body = "Success";
        ...
        String secondResult = api.invoke();
        assertThat(secondResult).isEqualTo("fallback");
    }
